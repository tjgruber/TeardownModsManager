<# Teardown Mods Manager v2.1.2 | by Timothy Gruber
...
if ($myWindowsPrincipal.IsInRole($adminRole)) {
    $Host.UI.RawUI.WindowTitle = "Teardown Mods Manager v2.1.2 | by Timothy Gruber"
...
Write-Host "Running Teardown Mods Manager v2.1.2 | by Timothy Gruber...`n`nClosing this window will close Teardown Mods Manager.`n"
...
<Window
    ...
    Title="Teardown Mods Manager v2.1.2 | by Timothy Gruber" Height="540" Width="1000" ScrollViewer.VerticalScrollBarVisibility="Disabled" MinWidth="966" MinHeight="500">
    <Grid>
        <DockPanel>
...
#  ███████ ██   ██ ██       ██████  ██   ██    ██        ███████  ██████   ██████  ███████     ██████   ██████     ██       ██     ██████  ██   ████ 
    ...
    $syncHash.ExportLogsButton.Add_Click({
        ...
        if ($SaveDialog.Filename) {
            [System.Windows.Forms.MessageBox]::Show("Logs exported at $($SaveDialog.Filename)","Log Export | Teardown Mods Manager v2.1.2")
